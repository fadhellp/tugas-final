...
@if (Session::get('success'))
    <div class="alert alert-success alert_dismissible fade show">
        <ul>
...
@endif
					...
					<div style="margin : 20px 20px 40px 20px;">
						<label for="gambar" style="margin-bottom: 10px; font-size: 16pt; color: #666666;">Gambar</label>
				...
				<div class="login100-more" style="background-image: url('{{ asset('halaman_auth/images/doctor.jpg') }}');">
				</div>
			</div>
		</div>
	</div>
